## AudioSplitAi 3.0 — Music Source Separation Desktop App
...
> **Version 3.0** is a complete rewrite. The old AudioSplit + TensorFlow engine has been replaced by **audio-separator 0.44** running on **Python 3.13** with **PyTorch CPU**, supporting modern Mel-Band Roformer and HTDemucs models.
...
| | v2.x (old) | v3.0 (new) |
|---|---|---|
| Separation engine | AudioSplit 2.4 | audio-separator 0.44 |
...
| 7/10/2023 | 2.9.5 | Rebuilt with Python 3.10.10 and AudioSplit 2.4. Updated GUI. New website audiosplitai.com |
| 5/04/2022 | 2.9.2 | Upgraded AudioSplit to 2.3.0. Updated Python files. |
| 30/01/2021 | 2.9.1 | Upgraded AudioSplit to 2.1.2. Updated command syntax. |
| 9/11/2020 | 2.9 | Upgraded AudioSplit to 2.0.1 and Python. |
